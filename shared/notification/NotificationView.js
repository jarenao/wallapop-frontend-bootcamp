export function buildNotificationView(message) {
  ...
  <div
    id="toast-success"
    class="alert-banner flex absolute top-5 right-5 items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
    role="alert"
    >
    <div
